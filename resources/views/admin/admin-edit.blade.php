                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img class="card-img-top img-cover @error('profile_photo') is-invalid @enderror"
                                    ...
                                    <input type="file"
                                        ...
                                        tabindex="8" name="profile_photo" id="profile_photo" style="display:none;" style="width: 50% !important"
