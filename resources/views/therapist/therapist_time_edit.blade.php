...
@section('title') {{ __('Update Therapist Time Slot') }} @endsection
@section('css')
    ...
    @section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('time-update/' . $therapist->id) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $therapist->id }}" id="form_id" />
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control select2 @error('slot_time') is-invalid @enderror"
                                        ...
                                        @for ($i = 1; $i <= 60; $i++)
                                            <option value="{{ $i }}"
                                                {{ $i == $therapist_info->slot_time ? 'selected' : '' }}>
                                                {{ $i }}
                                            </option>
                                        @endfor
                                    </select>
