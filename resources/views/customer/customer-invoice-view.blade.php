                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <address>
                                    <strong>{{ __('Therapy Details') }}</strong><br>
                                    {{ $invoice_detail->therapy->first_name . ' ' . $invoice_detail->therapy->last_name }}<br>
                                    <i class="mdi mdi-phone"></i> {{ $invoice_detail->therapy->mobile }}<br>
                                    <i class="mdi mdi-email"></i> {{ $invoice_detail->therapy->email }}<br>
                                </address>
                            </div>
                            <div class="col-3">
                                <address>
