                                ...
                                @foreach ($prescriptions_details as $item)
                                        <tr>
                                            ...
                                            @if ($role == 'receptionist')
                                                <td>{{ $item->customer->first_name . ' ' . $item->customer->first_name }}
                                                </td>
                                                <td>{{ $item->therapy->first_name . ' ' . $item->therapy->first_name }}
                                                </td>
                                            @elseif ($role == 'therapy')
                                                <td>{{ $item->customer->first_name }}
                                                    {{ $item->customer->last_name }}</td>
                                            @elseif ($role == 'customer')
                                                <td>{{ $item->therapy->first_name }}
                                                    {{ $item->therapy->last_name }}</td>
                                            @else
                                                <td>{{ $item->customer->first_name }}
                                                    {{ $item->customer->last_name }}</td>
                                                <td>{{ $item->therapy->first_name }}
