...
@section('title'){{ __('Update Customer') }}@endsection
@section('body')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="@if ($customer){{ old('first_name', $customer->first_name) }}@elseif(old('first_name')){{ old('first_name') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control @error('gender') is-invalid @enderror" tabindex="3"
                                                ...
                                                <option value="Male" @if (($customer_info && $customer_info->gender == 'Male') || old('gender') == 'Male') selected @endif>{{ __('Male') }}</option>
                                                <option value="Female" @if (($customer_info && $customer_info->gender == 'Female') || old('gender') == 'Female') selected @endif>{{ __('Female') }}
                                                </option>
                                                <option value="Other" @if (($customer_info && $customer_info->gender == 'Other') || old('gender') == 'Other') selected @endif>{{ __('Other') }}</option>
                                            </select>
                                            @error('gender')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                tabindex="5" name="email" id="customerEmail" value="@if ($customer){{ old('email', $customer->email) }}@elseif(old('email')){{ old('email') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea id="formmessage" name="address" tabindex="7"
                                                ...
                                                placeholder="{{ __('Enter Current Address') }}">@if ($customer && $customer_info){{ $customer_info->address }}@elseif(old('address')){{ old('address') }}@endif</textarea>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                tabindex="2" name="last_name" id="LastName" value="@if ($customer){{ old('last_name', $customer->last_name) }}@elseif(old('last_name')){{ old('last_name') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('age') is-invalid @enderror"
                                                tabindex="4" name="age" id="customerAge" value="@if ($customer && $customer_info ){{ old('age', $customer_info->age) }}@elseif(old('age')){{ old('age') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="tel" class="form-control @error('mobile') is-invalid @enderror"
                                                tabindex="6" name="mobile" id="customerMobile"
                                                value="@if ($customer){{ old('mobile', $customer->mobile) }}@elseif(old('mobile')){{ old('mobile') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <img class="@error('profile_photo') is-invalid @enderror "
                                                src="@if ($customer && $customer->profile_photo != null){{ URL::asset('storage/images/users/' . $customer->profile_photo) }}@else{{ URL::asset('assets/images/users/noImage.png') }}@endif" onclick="triggerClick()"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('height') is-invalid @enderror"
                                                name="height" tabindex="9" value="@if ($customer && $customer_info && $medical_info){{ old('height', $medical_info->height) }}@elseif(old('height')){{ old('height') }}@endif"
                                                id="customerHeight" placeholder="{{ __('Enter Height In Centimeter') }}">
                                            @error('height')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('pulse') is-invalid @enderror"
                                                tabindex="13" name="pulse" value="@if ($customer && $customer_info && $medical_info){{ old('pulse', $medical_info->pulse) }}@elseif(old('pulse')){{ old('pulse') }}@endif"
                                                id="customerPulse" placeholder="{{ __('Enter Pulse') }}">
                                            @error('pulse')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('allergy') is-invalid @enderror"
                                                tabindex="15" name="allergy" id="customerAllergy"
                                                value="@if ($customer && $customer_info && $medical_info){{ old('allergy', $medical_info->allergy) }}@elseif(old('allergy')){{ old('allergy') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control @error('weight') is-invalid @enderror"
                                                tabindex="10" name="weight" id="customerWeight"
                                                value="@if ($customer && $customer_info && $medical_info){{ old('weight', $medical_info->weight) }}@elseif(old('weight')){{ old('weight') }}@endif" placeholder="{{ __('Enter Weight') }}">
                                            @error('weight')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="tel"
                                                ...
                                                value="@if ($customer && $customer_info && $medical_info){{ old('b_pressure', $medical_info->b_pressure) }}@elseif(old('b_pressure')){{ old('b_pressure') }}@endif"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="tel"
                                                ...
                                                tabindex="14" name="respiration" id="customerRespiration"
                                                value="@if ($customer && $customer_info && $medical_info){{ old('respiration', $medical_info->respiration) }}@elseif(old('respiration')){{ old('respiration') }}@endif"
