                                ...
                                <?php $__currentLoopData = $prescriptions_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if($role == 'receptionist'): ?>
                                                <td><?php echo e($item->customer->first_name . ' ' . $item->customer->first_name); ?>

                                                </td>
                                                <td><?php echo e($item->therapy->first_name . ' ' . $item->therapy->first_name); ?>

                                                </td>
                                            <?php elseif($role == 'therapy'): ?>
                                                <td><?php echo e($item->customer->first_name); ?>

                                                    <?php echo e($item->customer->last_name); ?></td>
                                            <?php elseif($role == 'customer'): ?>
                                                <td><?php echo e($item->therapy->first_name); ?>

                                                    <?php echo e($item->therapy->last_name); ?></td>
                                            <?php else: ?>
                                                <td><?php echo e($item->customer->first_name); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\Project\youliantang\resources\views/customer/customer-prescriptions.blade.php ENDPATH**/ ?>