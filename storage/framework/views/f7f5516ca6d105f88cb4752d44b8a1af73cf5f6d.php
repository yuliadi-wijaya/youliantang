<?php $__env->startSection('title'); ?> <?php echo e(__('Report Transaction History Detail')); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('body'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Report Transaction History Detail <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Reports <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_4'); ?> Report Transaction History Detail <?php $__env->endSlot(); ?>
        <?php echo $__env->renderComponent(); ?>
        <!-- end page title -->
        <div class="row d-print-none">
            <div class="col-12">
                <a href="<?php echo e(url('/rf-trans')); ?>">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Filter Transaction')); ?>
                ...
                <form id="export-form" action="<?php echo e(route('ex-trans')); ?>" method="GET" style="display: none;">
                    <?php echo csrf_field(); ?>
                            ...
                            <table class="table" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-wrap"><?php echo e($row->invoice_date); ?></td>
                                            <td class="no-wrap"><?php echo e($row->customer_name); ?></td>
                                            <td class="no-wrap"><?php echo e($row->customer_phone); ?></td>
                                            ...
                                            <td class="no-wrap"><?php echo e($row->old_data == 'Y' ? $row->therapist_phone : ''); ?></td>
                                        ...
                                        <?php $__currentLoopData = $report_detail[$row->invoice_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="no-wrap"><?php echo e($row->old_data == 'N' ? $rd->therapist_phone : ''); ?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="no-wrap"><?php echo e($t_duration); ?> Minutes</th>
                                        <th class="no-wrap">Rp. <?php echo e(number_format($t_fee, 0, ',', '.')); ?></th>
                                        <th class="no-wrap" colspan="2">&nbsp;</th>
                                    </tr>
                                    <tr>
                                        <th class="no-wrap" colspan="10">&nbsp;</th>
                                        <th class="no-wrap"><?php echo e(__('Total Revenue')); ?></th>
                                        <th class="no-wrap" colspan="2">&nbsp;</th>
                                        <th class="no-wrap">Rp. <?php echo e(number_format($t_grand_total - $t_fee, 0, ',', '.')); ?></th>
                                        <th class="no-wrap" colspan="10">&nbsp;</th>
                                    </tr>
                                </tfoot>
                            </table>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\youliantang\resources\views/report/transaction/trans-detail.blade.php ENDPATH**/ ?>