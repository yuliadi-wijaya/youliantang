<?php $__env->startSection('title'); ?>
    <?php if($customermember): ?>
        <?php echo e(__('Update Member Details')); ?>
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(url('customermember')); ?>"><?php echo e(__('Membership')); ?></a></li>
            ...
            <div class="col-12">
                <a href="<?php echo e(url('customermember')); ?>">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Member List')); ?>
