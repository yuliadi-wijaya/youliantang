...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('Report Customers')); ?>
...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Report Filter Customer Registration <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Reports <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_3'); ?> Customers <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_4'); ?> Report Filter Customer Registration <?php $__env->endSlot(); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('rs-customer-reg')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Registration Date ')); ?><span class="text-danger">*</span></label>
                                            <div class="row">
                                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label class="control-label"><?php echo e(__('Is Member ')); ?></label>
                                    <select class="form-control" name="is_member">
                                        <option value="All" <?php if(old('is_member') == 'All'): ?> selected <?php endif; ?>><?php echo e(__('All')); ?></option>
                                        <option value="1" <?php if(old('is_member') == '1'): ?> selected <?php endif; ?>><?php echo e(__('Yes')); ?></option>
                                        <option value="0" <?php if(old('is_member') == '0'): ?> selected <?php endif; ?>><?php echo e(__('No')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\Project\youliantang\resources\views/report/customer/filter-customer-regist.blade.php ENDPATH**/ ?>