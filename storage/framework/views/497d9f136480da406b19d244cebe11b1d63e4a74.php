...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            value="<?php if($promo ): ?><?php echo e(old('active_period_start', date('Y-m-d', strtotime($promo->active_period_start)))); ?><?php elseif(old('active_period_start')): ?><?php echo e(old('active_period_start')); ?><?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            value="<?php if($promo ): ?><?php echo e(old('active_period_end', date('Y-m-d', strtotime($promo->active_period_end)))); ?><?php elseif(old('active_period_end')): ?><?php echo e(old('active_period_end')); ?><?php endif; ?>">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                        </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\youliantang\resources\views/promo/promo-details.blade.php ENDPATH**/ ?>