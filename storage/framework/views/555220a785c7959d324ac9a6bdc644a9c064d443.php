...
unset($__errorArgs, $__bag); ?>"
                                                src="<?php if($therapist && $therapist->profile_photo != ''): ?> <?php echo e(URL::asset('storage/images/users/' . $therapist->profile_photo)); ?>  <?php else: ?> <?php echo e(URL::asset('assets/images/users/noImage.png')); ?> <?php endif; ?>" id="profile_display" onclick="triggerClick()"
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\Project\youliantang\resources\views/therapist/therapist-details.blade.php ENDPATH**/ ?>