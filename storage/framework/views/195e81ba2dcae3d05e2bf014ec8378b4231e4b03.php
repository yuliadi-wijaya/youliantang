                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label class="control-label"><?php echo e(__('Therapist ')); ?><span
                                                class="text-danger">*</span></label>
                                        <select
                                            class="form-control select2 sel-therapist <?php $__errorArgs = ['appointment_with'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__currentLoopData = $therapists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $therapist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($therapist->id); ?>"
                                                    <?php echo e(old('appointment_with') == $therapist->id ? 'selected' : ''); ?>>
                                                    <?php echo e($therapist->first_name); ?>

                                                    <?php echo e($therapist->last_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php else: ?>
                                <input type="hidden" name="appointment_with" value="<?php echo e($user->id); ?>" id="therapist">
                            <?php endif; ?>
                            <div class="row">
                                <div class="col-md-12 form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label for="" class="d-block"><?php echo e(__("Available Time")); ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="btn-group btn-group-toggle availble_time" data-toggle="buttons">
                                            <?php $__currentLoopData = $therapist_available_time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->startSection('script'); ?>
        ...
        <script>
            ...
            if (roles == 'therapist') {
                var day_therapist = '<?php echo e($dayArray); ?>';
            ...
            $('.sel-therapist').change(function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('therapist_by_day_time')); ?>",
                    data: {
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\Project\youliantang\resources\views/appointment/appointment_create.blade.php ENDPATH**/ ?>