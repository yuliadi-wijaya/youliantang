            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('translation.therapists')); ?></p>
                                <a href="<?php echo e(url('/therapist')); ?>" class="mb-0 font-weight-medium font-size-24">
                                    <h4 class="mb-0"><?php echo e(number_format($data['total_therapist'])); ?></h4>
                                </a>
                            </div>
                            <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                <span class="avatar-title rounded-circle bg-primary">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('translation.customers')); ?></p>
                                <a href="<?php echo e(url('/customer')); ?>" class="mb-0 font-weight-medium font-size-24">
                                    <h4 class="mb-0"><?php echo e(number_format($data['total_customer'])); ?></h4>
                                </a>
                            </div>
                            <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                <span class="avatar-title rounded-circle bg-primary">
                ...
                <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#Therapists" role="tab">
                            ...
                            <span class="d-none d-sm-block"><?php echo e(__('Therapists')); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#Customers" role="tab">
                            <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                            <span class="d-none d-sm-block"><?php echo e(__('Customers')); ?></span>
                        </a>
                    </li>
                </ul>
                <!-- Tab panes -->
                            ...
                            <table class="table table-centered table-nowrap mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $therapists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->index + 1); ?></td>
                                            <td><?php echo e($item->therapist->first_name); ?> <?php echo e($item->therapist->last_name); ?>

                                            </td>
                                            <td><?php echo e($item->therapist->mobile); ?></td>
                                            <td><?php echo e($item->therapist->email); ?></td>
                                            <td>
                                                <!-- Button trigger modal -->
                                                <a href="<?php echo e(url('therapist/' . $item->therapist->id)); ?>">
                                                    <button type="button"
...
<!-- end row -->
<?php /**PATH E:\Data\Project\youliantang\resources\views/layouts/receptionist-dashboard.blade.php ENDPATH**/ ?>