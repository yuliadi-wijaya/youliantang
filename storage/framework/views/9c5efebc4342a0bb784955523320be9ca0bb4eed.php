...
<?php $__env->startSection('title'); ?> <?php echo e(__('List of Product')); ?> <?php $__env->stopSection(); ?>
                ...
                <div class="card-body">
                    ...
                    <a href=" <?php echo e(route('product.create')); ?> ">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i class="bx bx-plus font-size-16 align-middle mr-2"></i> <?php echo e(__('New Product')); ?>
                    ...
                    <table id="productList" class="table table-bordered dt-responsive nowrap display" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('Commission Fee')); ?></th>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yuliadiwijaya/Documents/Freelance/You Lian tAng/youliantang/resources/views/product/products.blade.php ENDPATH**/ ?>