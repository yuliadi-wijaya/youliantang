                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <?php echo e(date('Y-m-d', strtotime($promo->active_period_start)) . " to " . date('Y-m-d', strtotime($promo->active_period_end))); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Data\Project\youliantang\resources\views/promo/promo-vouchers.blade.php ENDPATH**/ ?>