    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?php echo e(url('/')); ?>" class="logo logo-light pt-2">
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="" height="100">
                    </span>
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('assets/images/logo-light1.png')); ?>" alt="" height="50">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect" data-toggle="dropdown"
                    ...
                    <?php switch(Session::get('lang')):
                        ...
                        <?php case ('ae'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/ae.svg')); ?>" class="rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
...
<?php /**PATH /Users/yuliadiwijaya/Documents/Freelance/You Lian tAng/youliantang/resources/views/layouts/top-hor.blade.php ENDPATH**/ ?>